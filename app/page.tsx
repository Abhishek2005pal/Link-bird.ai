...
export default function HomePage() {
  ...
  if (session) {
    return null // Will redirect to /leads
  }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center">
          <h1 className="text-4xl font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
            Manage Your{' '}
            <span className="text-indigo-600">Leads & Campaigns</span>
          </h1>
          <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
            Streamline your lead generation and campaign management with our powerful platform. 
            Track, manage, and convert leads efficiently.
          </p>
